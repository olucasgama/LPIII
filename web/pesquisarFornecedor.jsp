...
<body>
    <ul class="main-nav">
        <h2>SGMC - Pesquisa de Fornecedores</h2>
    </ul>
    <table border=1 class="table">
        ...
        <c:forEach items="${fornecedores}" var="fornecedor">
            <tr>
                ...
                <td>
                    <c:out value="${fornecedor.nomeFantasia}" />
                </td>
                <td>
                    <c:out value="${fornecedor.nomeRepresentante}" />
                </td>
                <td>
                    <c:out value="${fornecedor.email}" />
                </td>
                <td>
                    <c:out value="${fornecedor.endereco.logradouro}" />
                </td>
                <td>
                    <c:out value="${fornecedor.numero}" />
                </td>
                <td>
                    <c:out value="${fornecedor.complemento}" />
                </td>
